                            ...
                            const ExpectedAttributes& expectedAttributes)
{
  ...
  for (int n = numErrs-1; n >= 0; n--)
  {
    if (log->getError(n)->getErrorId() == UnknownPackageAttribute)
    {
      ...
      log->logPackageError("qual", QualDefaultTermAllowedAttributes,
    ...
    else if (log->getError(n)->getErrorId() == UnknownCoreAttribute)
    {
      ...
      log->logPackageError("qual", QualDefaultTermAllowedCoreAttributes,
        pkgVersion, level, version, details);
    }
  }
  ...
  if ( mIsSetResultLevel == false)
  {
      ...
      log->contains(XMLAttributeTypeMismatch))
    {
      ...
      log->logPackageError("qual", QualDefaultTermResultLevelMustBeUnInteger,
