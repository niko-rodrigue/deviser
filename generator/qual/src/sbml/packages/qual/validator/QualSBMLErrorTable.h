...
static const packageErrorTableEntry qualErrorTable[] =
{
  ...
  { QualOutputAllowedAttributes,
    ...
    LIBSBML_CAT_GENERAL_CONSISTENCY,
    LIBSBML_SEV_ERROR,
    "An <output> object may have the optional attributes 'qual:id', "
    "'qual:qualitativeSpecies', 'qual:transitionEffect', 'qual:name' and "
    "'qual:outputLevel'. No other attributes from the SBML Level 3 Qualitative "
    "Models namespaces are permitted on an <output> object. ",
    { "L3V1 Qual V1 Section"
    }
  },
