#################################################
 # @file qual-package.cmake
 # @brief Src CMake file for qual package
 # @author SBMLTeam
 #
 # <!--------------------------------------------------------------------------
...
foreach(dir common extension sbml validator validator/constraints)
  ...
  file(GLOB qual_headers ${CMAKE_CURRENT_SOURCE_DIR}/sbml/packages/qual/${dir}/*.h)

  install(FILES ${qual_headers} DESTINATION include/sbml/packages/qual/${dir} )
