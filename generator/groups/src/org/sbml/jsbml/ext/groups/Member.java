...
public class Member extends AbstractNamedSBase implements UniqueNamedSBase {
   ...
   */
  private static final long serialVersionUID = 48116371605606857L;
  /**
   *
   */
  ...
  public int hashCode() {
    ...
    if (isSetMetaIdRef()) {
      hashCode += prime * getMetaIdRef().hashCode();
    }
    return hashCode;
  }
  ...
  public boolean readAttribute(String attributeName, String prefix, String value) {
    ...
    if (!isAttributeRead) {
      ...
      if (attributeName.equals(GroupsConstants.idRef)) {
        setIdRef(value);
        attributeName.equals(GroupsConstants.metaIdRef);
        setMetaIdRef(value);
      } else {
