...
public class GeneProductAssociation {
   ...
   */
  private static final long serialVersionUID = 54329172292522884L;
  /**
   *
   */
   ...
   */
  public GeneProductAssociation(GeneProductAssociation orig) {
    super(orig);
  ...
  public boolean equals(Object object) {
    ...
    if (equals) {
      GeneProductAssociation obj = (GeneProductAssociation) object;
  ...
  /* hashcode method for GeneProductAssociation.
   */
  @Override
  public int hashCode() {
    final int prime = 7988711;
