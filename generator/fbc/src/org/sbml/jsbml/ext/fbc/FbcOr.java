 ...
 * @date $Date: $
 */
public class FbcOr extends Association {

  /**
   * Generated serial version identifier.
   */
  private static final long serialVersionUID = 71918810873651648L;
  /**
   *
   */
   ...
   * @param version
   */
  public FbcOr(int level, int version) {
   ...
   * @param version
   */
  public FbcOr(String id, int level, int version) {
   ...
   * @param version
   */
  public FbcOr(String id, String name, int level, int version) {
  ...
  /* hashcode method for FbcOr.
   */
  @Override
  public int hashCode() {
    final int prime = 4171451;
