...
public class DynEventPlugin extends AbstractSBasePlugin {
   ...
   */
  private static final long serialVersionUID = 11847236171099495L;
  /**
   *
   */
   ...
   *  
   * @return {@code true} if applyToAll was set before, otherwise {@code false}.
   */
