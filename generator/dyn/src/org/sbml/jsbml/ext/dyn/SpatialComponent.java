...
public class SpatialComponent extends AbstractNamedSBase implements UniqueNamedSBase {
   ...
   */
  private static final long serialVersionUID = 68911280290185204L;
  /**
   *
   */
   ...
   *  
   * @return {@code true} if spatialIndex was set before, otherwise {@code false}.
   */
  ...
  public boolean readAttribute(String attributeName, String prefix, String value) {
    ...
    if (!isAttributeRead) {
      ...
      if (attributeName.equals(DynConstants.spatialIndex)) {
        ...
        attributeName.equals(DynConstants.variable);
        setVariable(value);
      } else {
