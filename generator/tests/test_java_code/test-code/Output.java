...
public class Output extends AbstractNamedSBase implements UniqueNamedSBase, CallableSBase {
   ...
   *  
   * @return {@code true} if outputLevel was set before, otherwise {@code false}.
   */
  public boolean unsetOutputLevel() {
    if (isSetOutputLevel()) {
      Integer oldOutputLevel = outputLevel;
      outputLevel = null;
      firePropertyChange(QualConstants.outputLevel, oldOutputLevel, outputLevel);
      return true;
    }
    return false;
  }
  ...
  public boolean readAttribute(String attributeName, String prefix, String value) {
    ...
    if (!isAttributeRead) {
      ...
      if (attributeName.equals(QualConstants.qualitativeSpecies)) {
        ...
        attributeName.equals(QualConstants.outputLevel);
