...
public class Domain {
  ...
  /**
   * @return the value of the "id" attribute of this Domain.
   */
  public String getId() {
    return isSetId() ? mId : "";
  }
  ...
  /**
   * @return the value of the "domainType" attribute of this Domain.
   */
  ...
  /**
   * Predicate returning {@code true} if this Domain's "id" attribute is set.
   */
  ...
  /**
   * Predicate returning {@code true} if this Domain's "domainType" attribute
   * is set.
   */
